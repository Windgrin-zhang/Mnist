...
if __name__ == "__main__":
    train_imgs = parse_mnist(minst_file_addr="./mnist/MNIST/raw/train-images-idx3-ubyte.gz")  # 训练集图像
    train_labels = parse_mnist(minst_file_addr="./mnist/MNIST/raw/train-labels-idx1-ubyte.gz")  # 训练集标签
