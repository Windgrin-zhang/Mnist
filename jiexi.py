...
if __name__ == "__main__":
    data = parse_mnist(minst_file_addr="./mnist/MNIST/raw/t10k-labels-idx1-ubyte.gz")  # t10k-images-idx1-ubyte.gz文件应该和本脚本在同一个目录下，否则应该修改地址
    print(len(data))  # 10000
    print(data[0:100])  # [7 2 1 0 4 1 4 9 5 9]
